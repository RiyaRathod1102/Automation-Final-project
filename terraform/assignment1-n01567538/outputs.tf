...
output "virtual_network_name" {
  value = module.network-n01567538.virtual_network_name
}
output "subnet_name" {
...
output "loadbalancer" {
  value = module.loadbalancer-n01567538.n01567538-loadbalancer-name
}

output "loadbalancer-ip" {
  value = module.loadbalancer-n01567538.n01567538-loadbalancer-ip
}
